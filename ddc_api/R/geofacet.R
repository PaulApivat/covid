...
> bkk_reduce_grid[5,9] <- 'Bang Khae'
> bkk_reduce_grid[6,9] <- 'Bangkok Noi'
> bkk_reduce_grid[7,9] <- 'Taling Chan'
> bkk_reduce_grid[8,9] <- 'Thawi Watthana'
> bkk_reduce_grid[9,9] <- 'Thung Khru'
> bkk_reduce_grid[10,9] <- 'Rat Burana'
> bkk_reduce_grid[11,9] <- 'Chom Thong'
> bkk_reduce_grid[12,9] <- 'Thon Buri'
> bkk_reduce_grid[13,9] <- 'Bangkok Yai'
> bkk_reduce_grid[14,9] <- 'Bang Kho Laem'
> bkk_reduce_grid[15,9] <- 'Khlong San'
> bkk_reduce_grid[16,9] <- 'Samphanthawong'
> bkk_reduce_grid[17,9] <- 'Pom Prap Sattru Phai'
> bkk_reduce_grid[18,9] <- 'Phra Nakhon'
> bkk_reduce_grid[19,9] <- 'Bang Phlat'
> bkk_reduce_grid[20,9] <- 'Bang Rak'
> bkk_reduce_grid[21,9] <- 'Pathum Wan'
> bkk_reduce_grid[22,9] <- 'Dusit'
> bkk_reduce_grid[23,9] <- 'Bang Sue'
> bkk_reduce_grid[24,9] <- 'Yan Nawa'
> bkk_reduce_grid[25,9] <- 'Sathon'
> bkk_reduce_grid[26,9] <- 'Khlong Toei'
> bkk_reduce_grid[27,9] <- 'Watthana'
> bkk_reduce_grid[28,9] <- 'Ratchathewi'
> bkk_reduce_grid[29,9] <- 'Phaya Thai'
> bkk_reduce_grid[30,9] <- 'Din Daeng'
> bkk_reduce_grid[31,9] <- 'Chatuchak'
> bkk_reduce_grid[32,9] <- 'Lak Si'
> bkk_reduce_grid[33,9] <- 'Bang Na'
> bkk_reduce_grid[34,9] <- 'Phra Khanong'
> bkk_reduce_grid[35,9] <- 'Wang Thonglang'
> bkk_reduce_grid[36,9] <- 'Huai Khwang'
> bkk_reduce_grid[37,9] <- 'Bang Khen'
> bkk_reduce_grid[38,9] <- 'Bang Kapi'
> bkk_reduce_grid[39,9] <- 'Lat Phrao'
> bkk_reduce_grid[40,9] <- 'Don Mueang'
> bkk_reduce_grid[41,9] <- 'Suan Luang'
> bkk_reduce_grid[42,9] <- 'Bueng Kum'
> bkk_reduce_grid[43,9] <- 'Khan Na Yao'
> bkk_reduce_grid[44,9] <- 'Sai Mai'
> bkk_reduce_grid[45,9] <- 'Prawet'
> bkk_reduce_grid[46,9] <- 'Saphan Sung'
> bkk_reduce_grid[47,9] <- 'Khlong Sam Wa'
> bkk_reduce_grid[48,9] <- 'Lat Krabang'
